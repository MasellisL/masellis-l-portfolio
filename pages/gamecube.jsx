    ...
    return(
        <div className="main-gc-content">
            ...
            <div className="project-images-container">
                ...
                <img className="project-image" alt="react gamecube home page" src={gameCube}></img>
                ...
                <div className="image-and-text">
                <img className="project-image" alt="react gamecube cart page" src={gameCubeCart}></img>
                <div className="img-text-container">
                ...
                <div className="image-and-text">
                <img className="project-image" alt="react gamecube items page" src={gameCubeItems}></img>
                <div className="img-text-container">
