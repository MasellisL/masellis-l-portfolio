...
function Gamecube() {
    return(
        <div className="main-gc-content">
            <Link to="/"><img className="back-button" alt="back button icon" src={backButton}></img></Link>
            <div className="project-images-container">
                <div className="image-and-text">
                <img className="project-image" src={nestWorkHome} alt="React nestWork Home Page"></img>
                ...
                <div className="image-and-text">
                <img className="project-image" src={nestWorkResults} alt="React nestWork results Page"></img>
                <div className="img-text-container">
                ...
                <div className="image-and-text">
                <img className="project-image" src={nestWorkTutorial} alt="React nestwork tutorial page"></img>
                <div className="img-text-container">
